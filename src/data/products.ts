...
const bundleProducts: Product[] = [
    {
        ...
        localizedBundleContents: { zh: ['支付宝实名账号', '关联闲鱼号', '中文使用指南'], en: ['Alipay verified account', 'Linked Xianyu account', 'English setup guide'] },
    ...
    },
    {
        ...
        localizedBundleContents: { zh: ['支付宝实名账号', '淘宝买家号', '地址设置指南'], en: ['Alipay verified account', 'Taobao buyer account', 'Address setup guide'] },
        stockCount: 32,
        hasGooglePlay: true,
        sortOrder: 2,
    },
    {
        ...
        localizedBundleContents: { zh: ['企业支付宝账号', '1688批发账号', '一件代发操作指南'], en: ['Enterprise Alipay account', '1688 wholesale account', 'Dropshipping guide'] },
        stockCount: 15,
        hasGooglePlay: true,
        sortOrder: 3,
    },
    {
        ...
        localizedBundleContents: { zh: ['实名认证微信号', '京东账号', '京东白条额度说明'], en: ['Verified WeChat account', 'JD.com account', 'JD Baitiao credit guide'] },
        stockCount: 22,
        hasGooglePlay: true,
        sortOrder: 4,
    },
    {
        ...
        localizedBundleContents: { zh: ['微信+支付宝+淘宝+拼多多全套', '独立实名资料四份', '长期维护教程'], en: ['WeChat + Alipay + Taobao + PDD full set', '4x independent verified IDs', 'Long-term maintenance guide'] },
        stockCount: 10,
        popular: true,
        hasGooglePlay: true,
        sortOrder: 5,
