...
export function useGsapContext(
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.warn('[GSAP] Context initialization error:', err);
        }
 ...
 * Scoped safely inside a container element with try/catch guards.
 */
    ...
    useGsapContext(containerRef, () => {
        try {
            ...
            sections.forEach((section) => {
                if (!section || section.id === 'hot-products-section') return;
            ...
            headings.forEach((heading) => {
                if (!heading || heading.closest('[class*="hero"]') || heading.closest('header')) return;
            ...
            console.warn('[GSAP] Scroll animation setup error:', err);
        }
    });
