    ...
    const sections = [
        ...
        },
        {
            ...
            content: [
                ...
                'All complaints and disputes should be submitted via Telegram support (@Minsheng0) or email (support@cnwepro.com).',
        ...
        <div className="max-w-4xl mx-auto section-container py-12 md:py-24 min-h-[70vh]">
            ...
            <div className="mt-12 text-center bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8 border border-slate-100 dark:border-slate-800">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="https://t.me/Minsheng0" target="_blank" rel="noopener noreferrer" className="btn-primary">
                        Telegram Support
                    </a>
