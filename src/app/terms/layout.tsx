...
export const metadata: Metadata = {
    ...
    description: 'CNVerifyHub平台服务协议、支付条款、退款政策、隐私保护和免责声明。了解USDT支付流程、72小时质保政策和争议解决方式。Terms of Service for CNVerifyHub — payment, refund, privacy, and warranty policies.',
    alternates: {
        canonical: `${SITE_URL}/terms/`,
        languages: { 'zh-CN': `${SITE_URL}/terms/`, 'en': `${SITE_URL}/en/terms/` },
    },
    openGraph: {
        title: '服务条款与政策 | CNVerifyHub Terms',
