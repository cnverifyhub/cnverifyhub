...
export default function MobileNav() {
    ...
    useEffect(() => {
        ...
        const { data: { subscription } } = supabase.auth.onAuthStateChange(
            (_, session) => setIsLoggedIn(!!session)
        );
    ...
    const tabs = [
        ...
        { href: '/account', icon: User, label: lang === 'zh' ? '账号' : 'Account', badge: isLoggedIn },
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    ...
                                    />
                                    {tab.badge && (
                                        <span className="absolute top-0.5 right-3 w-2 h-2 rounded-full bg-emerald-400 border-2 border-white dark:border-dark-900" />
                                    )}
