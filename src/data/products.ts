...
const tradingProducts: Product[] = [
    {
        ...
        price: { single: 28.80, bulk10: 28.80, bulk50: 28.80, bulk200: 28.80, originalPrice: { single: 180.00, bulk10: 180.00, bulk50: 180.00, bulk200: 180.00 } },
        deliveryMethod: 'manual',
        stockCount: 10,
    ...
    },
    {
        ...
        price: { single: 26.80, bulk10: 26.80, bulk50: 26.80, bulk200: 26.80, originalPrice: { single: 180.00, bulk10: 180.00, bulk50: 180.00, bulk200: 180.00 } },
        deliveryMethod: 'manual',
        stockCount: 8,
