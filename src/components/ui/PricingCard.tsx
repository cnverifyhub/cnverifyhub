        ...
        >
            ...
            <div className="pl-5 pr-4 pt-4 pb-4 flex flex-col flex-1 relative z-20">
                ...
                <div className="flex items-baseline gap-2 mb-4 mt-auto">
                    <span className="font-mono-price text-2xl font-bold text-[#F0F4FF]">
                    ...
                    {discount && (
                        <span className="ml-auto flex items-center gap-0.5 text-[10px] font-bold text-[#07C160]">
                            <TrendingDown className="w-3 h-3" />省{formatYuan(product.price.originalPrice!.single - product.price.single)}
                        </span>
                    )}
                </div>
                ...
                {/* Flash Sale Banner */}
                {product.popular && !isOutOfStock && (
                    <div className="mb-4 flex items-center border border-[#FF5000]/30 bg-[#FF5000]/10 rounded overflow-hidden">
                        <div className="bg-gradient-to-r from-[#FF2D55] to-[#FF5000] text-white px-2 py-1 flex items-center justify-center">
                            <Zap className="w-3.5 h-3.5 fill-current" />
                        </div>
                        <div className="flex-1 px-2 py-1 flex items-center justify-between">
                            <span className="text-[9px] font-bold text-[#FF5000] uppercase tracking-wider">
                                {lang === 'zh' ? '秒杀倒计时' : 'FLASH SALE'}
                            </span>
                            <span className="text-[10px] font-mono font-bold text-[#FF5000]">
                                {formatTime(timeLeft)}
                            </span>
                        </div>
                    </div>
