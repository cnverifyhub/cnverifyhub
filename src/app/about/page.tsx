                ...
                <div className="bg-gradient-to-br from-red-600 to-orange-500 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a href="https://t.me/Minsheng0" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/30 text-white rounded-2xl font-black hover:bg-white/20 transition-all">
