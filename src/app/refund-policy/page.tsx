            ...
            <div className="section-container py-12 md:py-16 max-w-4xl mx-auto space-y-12">
                ...
                <div className="text-center bg-white dark:bg-dark-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <a href="https://t.me/cnverifyhub" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#24A1DE] text-white rounded-xl font-bold hover:shadow-lg transition-all">
