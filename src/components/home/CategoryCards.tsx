                    ...
                    {categories.map((category) => {
                        ...
                        return (
                            <Link
                                ...
                                className="group relative bg-white dark:bg-dark-950 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 hover:shadow-2xl hover:shadow-slate-200/50 dark:hover:shadow-black/50 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col h-full"
                            >
                                {/* Hot Search Badges */}
                                {category.id === 'wechat' && (
                                    ...
                                    <div className="flex items-start gap-4 mb-6">
                                        ...
                                        <div className="flex-1 pt-1">
                                            ...
                                            <div className="flex flex-wrap gap-1.5 mb-3">
                                                <span className="text-[10px] font-bold bg-red-50 text-red-500 dark:bg-red-500/10 px-2 py-0.5 rounded-md border border-red-100 dark:border-red-500/20">官方认证</span>
                                                <span className="text-[10px] font-bold bg-orange-50 text-orange-500 dark:bg-orange-500/10 px-2 py-0.5 rounded-md border border-orange-100 dark:border-orange-500/20">极速响应</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-auto">
                                        <div className="flex items-center justify-between mb-4 px-1">
                                            ...
                                            <span className="text-sm font-black text-slate-900 dark:text-white flex items-center gap-0.5">
                                                {stock} <ArrowRight className="w-3 h-3 opacity-30" />
                                            </span>
                                        </div>

                                        <div className="bg-[#f8f9fb] dark:bg-white/5 p-4 rounded-2xl flex items-center justify-between group-hover:bg-[#fff0f0] dark:group-hover:bg-red-500/5 transition-colors duration-300">
                                            <div className="flex flex-col">
                                                ...
                                                <div className="flex items-baseline gap-1">
                                                    <span className="text-sm font-black text-[#ff5000]">USDT</span>
                                            ...
                                            <div className="w-10 h-10 rounded-full bg-[#eef1f5] dark:bg-white/10 flex items-center justify-center group-hover:bg-[#ff5000] group-hover:scale-110 transition-all duration-300 shadow-sm group-hover:shadow-lg group-hover:shadow-orange-500/25">
